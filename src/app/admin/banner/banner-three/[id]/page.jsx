...
const EditBannerThreePage = () => {
    ...
    const fetchCategory = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:5001/api/admin/bannerThree/${categoryId}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5001/api/admin/update/bannerThree/${categoryId}`,
        formDataToSend,
        {
          headers: {
      ...
      Swal.fire("Success!", "Category updated successfully!", "success").then(
        () => {
          router.push("/admin/banner/banner-three");
        }
      );
    } catch (err) {
      setError(err.message);
  ...
  return (
    <div className="fontPoppins p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <Link
          href="/admin/banner/banner-three"
...
export default EditBannerThreePage;
