...
const handleBuyNowAction = () => {
    ...
    <div className="fontPoppins bangla-text flex flex-col gap-4 ">
      ...
      <div className="flex flex-col gap-2 ">
        ...
        <div className="flex flex-row layoutFlexOne gap-5">
          <div className="flex flex-row w-full largeWidth  items-center justify-between rounded-full border border-gray-300 dark:border-gray-300 px-3 py-1.5 focus-within:ring-2 focus-within:ring-primary-500 focus-within:border-transparent transition-all duration-200 hover:border-gray-400 dark:hover:border-gray-400 dark:bg-white">
  <button
  ...
  whileTap={{ scale: 0.97 }}
  className={`transition-all duration-200 cursor-pointer px-6 py-3 rounded-full flex items-center justify-center gap-2 font-medium ${
    productInCart
...
>
   <>
      ...
      <div class="social-icons mt-4">
        <a className="cursor-pointer" href="https://www.facebook.com/profile.php?id=61571047718168&rdid=bn7i0Ydnh3ytv117&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1CNTmoEddS%2F#" target="_blank" aria-label="Facebook">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="#50C878">
            <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
          </svg>
        </a>

        <a className="cursor-pointer" href="https://www.instagram.com/bookforest2025?utm_source=qr&igsh=MWh2cTUydmFvd2IwaQ%3D%3D" target="_blank" aria-label="Instagram">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="#50C878">
        ...
        <a className="cursor-pointer" href="https://www.linkedin.com/in/book-forest-27502b379/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" aria-label="LinkedIn">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="#50C878">
...
{/* 
        ...
        <a className="cursor-pointer" href="https://x.com/BookForest2025?t=6H2hD3PaUSou4-kFFN_X9g&s=09" target="_blank" aria-label="X">
  <svg width="24" height="24" viewBox="0 0 24 24" fill="#50C878">
    <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/>
  </svg>
</a>
<a className="cursor-pointer" href="https://www.tiktok.com/@book.forest2?_t=ZS-8yeKXSCgzGE&_r=1" target="_blank" aria-label="TikTok">
  <svg width="24" height="24" viewBox="0 0 24 24" fill="#50C878">
