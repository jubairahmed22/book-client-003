...
const AddBannerThreeForm = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5001/api/admin/upload/banner-three",
        formData,
          ...
          <div className="flex flex-row gap-5">
            ...
            <div className="w-[60%]">
              <label className="block text-sm fontPoppins   text-gray-800 mb-1">
                Product route link <span className="text-red-500">*</span>
              </label>
...
export default AddBannerThreeForm;
